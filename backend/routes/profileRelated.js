...
profileRouter.post('/create-my-profile' , accessValidator , profileFetchAndUpdateHandler.userProfile );
profileRouter.post('/create-provider-profile' , accessValidator , profileFetchAndUpdateHandler.serviceProfile );
profileRouter.post('/create-emergency-contacts' , accessValidator , profileFetchAndUpdateHandler.emergencySetter)
